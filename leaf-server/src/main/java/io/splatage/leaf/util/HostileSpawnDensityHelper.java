...
public final class HostileSpawnDensityHelper {
    ...
    public static boolean isEnabledFor(final MobCategory category) {
        return HostileSpawnDensity.densityEnabled && category == MobCategory.MONSTER;
    }
    ...
    public static int resolveGlobalLimit(final MobCategory category, final int vanillaLimit) {
        if (!isEnabledFor(category)) {
            return vanillaLimit;
        }
